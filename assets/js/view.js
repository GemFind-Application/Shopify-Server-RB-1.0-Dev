                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response.output.status == 2){
                                ...
                                $("#gemfind-drop-email-friend-required label").empty();
                                $("#gemfind-drop-request-moreinfo-required label").empty();
                                $("#gemfind-drop-schedule-viewing-required label").empty();
                                $('.loading-mask.gemfind-loading-mask').css('display', 'none');
                                $('#gemfind-drop-hint-required label').append(response.output.msg);
                                $('#gemfind-drop-email-friend-required label').append(response.output.msg);
                                $('#gemfind-drop-request-moreinfo-required label').append(response.output.msg);
                                $('#gemfind-drop-schedule-viewing-required label').append(response.output.msg); 
                                return true;
                            }
